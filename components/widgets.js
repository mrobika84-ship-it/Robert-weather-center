window.RWC_WIDGETS = {
  mountHeader(){
    ...
    document.getElementById("appHeader").innerHTML=`
      ...
      <div class="edition-zone"><div id="headerWeatherIcon" class="header-weather-icon">☀️</div><div><div class="edition-title">Dolomites Edition · V6 Ultimate</div><div id="headerCondition" class="edition-subtitle">Időjárás betöltése…</div></div></div>
  ...
  mountFooter(){
    document.getElementById("appFooter").innerHTML=`
      ...
      <div><span>⏱ Frissítési intervallum</span><strong>3 perc</strong></div>
      ...
      <div><span>💚</span><strong>Robert Weather Center</strong></div>`;
  }
};
