window.RWC_WIDGETS = {
  mountHeader(){
    ...
    document.getElementById("appHeader").innerHTML=`
      ...
      <div class="edition-zone"><div id="headerWeatherIcon" class="header-weather-icon">☀️</div><div><div class="edition-title">Dolomites Edition · V8.7 Dynamic</div><div class="v8-badge">RESPONSIVE PRO</div><div id="headerCondition" class="edition-subtitle">Időjárás betöltése…</div></div></div>
  ...
  mountFooter(){
    document.getElementById("appFooter").innerHTML=`
      ...
      <div><span>💚</span><strong>Robert Weather Center V8.7</strong></div>`;
  }
};
